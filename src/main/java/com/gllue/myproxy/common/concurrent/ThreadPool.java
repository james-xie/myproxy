...
public final class ThreadPool {
  ...
  public ThreadPool(final Configurations configurations) {
    int processors = configurations.getValue(Configurations.Type.GENERIC, GenericConfigPropertyKey.PROCESSORS);
  ...
  private ExecutorBuilder fixedExecutorBuilder(final int processors) {
    ...
    int maxQueueSize =
        configurations.getValue(
            Configurations.Type.GENERIC, GenericConfigPropertyKey.THREAD_POOL_FIXED_EXECUTOR_QUEUE_SIZE);
