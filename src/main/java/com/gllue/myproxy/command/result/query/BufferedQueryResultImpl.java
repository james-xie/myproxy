...
public class BufferedQueryResultImpl implements BufferedQueryResult {
  ...
  public BufferedQueryResultImpl(
  ...
  public BufferedQueryResultImpl(final QueryResultMetaData metaData) {
    this(metaData, INITIAL_BUFFER_CAPACITY);
  }

  public BufferedQueryResultImpl(final QueryResultMetaData metaData, final int initCapacity) {
    this(
        metaData,
        initCapacity,
        MAX_BUFFER_CAPACITY,
