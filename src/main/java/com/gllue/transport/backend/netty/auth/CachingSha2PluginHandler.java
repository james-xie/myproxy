...
import static com.gllue.common.util.SecurityUtils.RSA_SHA1_MGF1_PADDING_TRANSFORMATION;
...
import com.gllue.transport.protocol.packet.PacketWrapper;
import com.gllue.transport.protocol.packet.generic.GenericPacketWrapper;
import com.gllue.transport.protocol.packet.generic.RawPacket;
...
public class CachingSha2PluginHandler implements AuthenticationPluginHandler {
  ...
  private byte[] sha2RsaEncrypt(final AuthenticationData authData, final String serverPublicKey)
    ...
    return SecurityUtils.encryptWithRSAPublicKey(
        scrambleBytes, publicKey, RSA_SHA1_MGF1_PADDING_TRANSFORMATION);
  }
