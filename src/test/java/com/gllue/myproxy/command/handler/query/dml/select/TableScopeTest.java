...
public class TableScopeTest {
  ...
  public void testTableAddAndGet() {
    ...
    Assert.assertEquals(table1, scope.getTable("db1", "ta"));
    Assert.assertEquals(table2, scope.getTable("db2", "ta"));
    Assert.assertEquals(table3, scope.getTable("db1", "ta1"));
  ...
  public void testInheritableGet() {
    ...
    Assert.assertEquals(table1, scope3.getTable("db1", "ta"));
    Assert.assertEquals(table3, scope3.getTable("db2", "ta"));
    Assert.assertEquals(table3, scope3.getTable("db3", "ta1"));
  }
