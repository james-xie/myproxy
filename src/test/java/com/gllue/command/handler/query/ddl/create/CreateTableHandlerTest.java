...
import com.gllue.common.FuturableCallback;
...
public class CreateTableHandlerTest extends BaseQueryHandlerTest {
  ...
  public void testExecuteWithEncryptAndPartition() throws InterruptedException, ExecutionException {
    ...
    assertEquals(3, table.getNumberOfTables());
    assertEquals(
    ...
    assertEquals(ColumnType.ENCRYPT, table.getColumn("p_col_2").getType());
    assertEquals(ColumnType.ENCRYPT, table.getColumn("e_col_6").getType());
  }
  ...
  public void testExecuteWithEncrypt() throws InterruptedException, ExecutionException {
    ...
    assertEquals("table", table.getName());
    assertEquals(List.of("id", "p_col_1", "p_col_2", "p_col_3"), table.getColumnNames());
    assertEquals(ColumnType.ENCRYPT, table.getColumn("p_col_2").getType());
  }
