...
public class AlterTableStatementProcessorTest extends BaseQueryHandlerTest {
  ...
  public void testAlterTableAddColumn() {
    ...
    var columns = Map.of("col1", newColumnDefinition("col1", ColumnType.VARCHAR, true, null, null));
  ...
  public void testAlterTableAddColumnWhenColumnInDatabase() {
    ...
    var columns =
        Map.of(
            "col1",
            newColumnDefinition("col1", ColumnType.VARCHAR, true, null, null),
            "col2",
            newColumnDefinition("col2", ColumnType.VARBINARY, false, null, null));
    var processor = prepareProcessor(table, columns);
    var alterSql =
        "ALTER TABLE `table` "
  ...
  public void testProcessModifyColumn() {
    ...
    var columns =
        Map.of(
            ...
            newColumnDefinition("col1", ColumnType.VARCHAR, true, null, null),
            "col2",
            newColumnDefinition("col2", ColumnType.INT, false, null, null),
            "col3",
            newColumnDefinition("col3", ColumnType.ENCRYPT, true, null, null));
    var processor = prepareProcessor(table, columns);
    var alterSql =
        "ALTER TABLE `table` "
  ...
  public void testProcessModifyColumnWhenColumnNotInTable() {
    ...
    builder.addColumn(
        new ColumnMetaData.Builder()
            ...
            .build());
    var table = builder.build();
    var columns = Map.of("col2", newColumnDefinition("col2", ColumnType.INT, false, null, null));
    var processor = prepareProcessor(table, columns);
  ...
  public void testProcessModifyColumnWhenColumnInDatabase() {
    ...
    var columns =
        Map.of(
            "col1",
            newColumnDefinition("col1", ColumnType.VARBINARY, false, null, null),
            "col2",
            newColumnDefinition("col2", ColumnType.INT, false, null, null),
            "col3",
            newColumnDefinition("col3", ColumnType.VARCHAR, false, null, null));
    var processor = prepareProcessor(table, columns);
    var alterSql =
        "ALTER TABLE `table` "
            + "MODIFY COLUMN `col1` ENCRYPT NOT NULL,"
  ...
  public void testProcessChangeColumnWhenColumnInDatabase() {
    ...
    var columns =
        Map.of(
            "col_1",
            newColumnDefinition("col_1", ColumnType.VARBINARY, false, null, null),
            "col_2",
            newColumnDefinition("col_2", ColumnType.INT, false, null, null),
            "col_3",
            newColumnDefinition("col_3", ColumnType.VARCHAR, false, null, null));
    var processor = prepareProcessor(table, columns);
    var alterSql =
        "ALTER TABLE `table` "
            + "CHANGE COLUMN `col1` `col_1` ENCRYPT NOT NULL,"
  ...
  public void testProcessDropColumn() {
    ...
    var columns =
        Map.of(
            "col1", newColumnDefinition("col1", ColumnType.VARCHAR, true, null, null),
            "col2", newColumnDefinition("col2", ColumnType.VARCHAR, true, null, null));
    var processor = prepareProcessor(table, columns);
